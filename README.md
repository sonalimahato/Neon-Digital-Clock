...
- **Readable Neon Design:** Optimized glow effects for high visibility and style.
- **Auto-Date:** Shows the current day and date automatically.
- **Mobile Friendly:** Fully responsive layout that centers on any screen.

## 🛠️ Built With
- **HTML5** - **CSS3** (Custom Glow Effects)
- **JavaScript** (setInterval & Date Logic)
